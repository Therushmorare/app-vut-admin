...
"[project]/src/app/components/Reports/ReportsDashboard.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ReportsDashboard({ companies = [], placements = [], allocatedLearners = [], agreements = [], fundingWindows = [], students = [] }) {
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ReportsDashboard.useMemo[stats]": ()=>{
            const totalLearners = allocatedLearners.length;
            const totalCompanies = companies.length;
            const totalPlacements = placements.length;
            const activeSETAs = agreements.filter({
                "ReportsDashboard.useMemo[stats]": (a)=>a.status === 'Active'
            }["ReportsDashboard.useMemo[stats]"]).length;
            // Placement Status
            const activePlacements = placements.filter({
                "ReportsDashboard.useMemo[stats]": (p)=>p.status === 'Active'
            }["ReportsDashboard.useMemo[stats]"]).length;
            const completedPlacements = placements.filter({
                "ReportsDashboard.useMemo[stats]": (p)=>p.status === 'Completed'
            }["ReportsDashboard.useMemo[stats]"]).length;
            const onHoldPlacements = placements.filter({
                "ReportsDashboard.useMemo[stats]": (p)=>p.status === 'On Hold'
            }["ReportsDashboard.useMemo[stats]"]).length;
            const terminatedPlacements = placements.filter({
                "ReportsDashboard.useMemo[stats]": (p)=>p.status === 'Terminated'
            }["ReportsDashboard.useMemo[stats]"]).length;
            // Learner Status
            const placedLearnerIds = placements.map({
                "ReportsDashboard.useMemo[stats].placedLearnerIds": (p)=>p.student_id
            }["ReportsDashboard.useMemo[stats].placedLearnerIds"]);
            const placedLearners = allocatedLearners.filter({
                "ReportsDashboard.useMemo[stats]": (l)=>placedLearnerIds.includes(l.student_id)
            }["ReportsDashboard.useMemo[stats]"]).length;
            const unplacedLearners = totalLearners - placedLearners;
            // Faculty Distribution
            const facultyDistribution = allocatedLearners.reduce({
                "ReportsDashboard.useMemo[stats].facultyDistribution": (acc, allocation)=>{
                    const student = students.find({
                        "ReportsDashboard.useMemo[stats].facultyDistribution.student": (s)=>s.id === allocation.student_id
                    }["ReportsDashboard.useMemo[stats].facultyDistribution.student"]);
                    if (student) {
            ...
            }["ReportsDashboard.useMemo[stats].facultyDistribution"], {});
            // SETA Distribution
            const setaDistribution = allocatedLearners.reduce({
                "ReportsDashboard.useMemo[stats].setaDistribution": (acc, learner)=>{
                    const agreement = agreements.find({
                        "ReportsDashboard.useMemo[stats].setaDistribution.agreement": (a)=>a.agreement_id === learner.agreement_id
                    }["ReportsDashboard.useMemo[stats].setaDistribution.agreement"]);
                    const setaName = agreement?.name || 'Unknown';
                    acc[setaName] = (acc[setaName] || 0) + 1;
                    return acc;
                }
            }["ReportsDashboard.useMemo[stats].setaDistribution"], {});
            // Company Capacity Utilization
            const totalCapacity = companies.reduce({
                "ReportsDashboard.useMemo[stats].totalCapacity": (sum, c)=>sum + parseInt(c.learnerCapacity || 0)
            }["ReportsDashboard.useMemo[stats].totalCapacity"], 0);
            const utilizationRate = totalCapacity > 0 ? (activePlacements / totalCapacity * 100).toFixed(1) : 0;
            // Funding Window Stats
            const activeFundingWindows = fundingWindows.filter({
                "ReportsDashboard.useMemo[stats]": (w)=>{
                    const now = new Date();
    ...
    const StatCard = ({ title, value, icon: Icon, color, subtext })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-2xl font-bold",
                                        style: {
                                            color: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["COLORS"].warning
                                        },
...
_s(ReportsDashboard, "3FvJDKtC3yF1gbNv5/WixcrN7Rs=");
_c = ReportsDashboard;
var _c;
...
"[project]/src/app/components/Reports/Filters.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdvancedFilters({ companies = [], agreements = [], fundingWindows = [], allocatedLearners = [], students = [], onFilterChange }) {
    ...
    const filterOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdvancedFilters.useMemo[filterOptions]": ()=>{
            // Map allocatedLearners to full student data
            const mappedLearners = allocatedLearners.map({
                "AdvancedFilters.useMemo[filterOptions].mappedLearners": (l)=>students.find({
                        "AdvancedFilters.useMemo[filterOptions].mappedLearners": (s)=>s.id === l.student_id
                    }["AdvancedFilters.useMemo[filterOptions].mappedLearners"])
            }["AdvancedFilters.useMemo[filterOptions].mappedLearners"]).filter(Boolean); // remove undefined if student not found
            const faculties = [
                ...new Set(mappedLearners.map({
                    "AdvancedFilters.useMemo[filterOptions]": (s)=>s.faculty
                }["AdvancedFilters.useMemo[filterOptions]"]).filter(Boolean))
            ];
            const programmes = [
                ...new Set(mappedLearners.map({
                    "AdvancedFilters.useMemo[filterOptions]": (s)=>s.programme
                }["AdvancedFilters.useMemo[filterOptions]"]).filter(Boolean))
            ];
            const years = [
                ...new Set(fundingWindows.map({
                    "AdvancedFilters.useMemo[filterOptions].years": (w)=>{
                        const year = new Date(w.start_data).getFullYear();
                        return year;
                    }
                }["AdvancedFilters.useMemo[filterOptions].years"]).filter(Boolean))
            ].sort({
                "AdvancedFilters.useMemo[filterOptions].years": (a, b)=>b - a
            }["AdvancedFilters.useMemo[filterOptions].years"]);
            return {
                faculties,
                programmes,
                years
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                    ...
                                    children: [
                                        ...
                                        filterOptions.faculties.map((faculty)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                value: faculty,
                                                children: faculty
                                            }, faculty, false, {
                                                fileName: "[project]/src/app/components/Reports/Filters.jsx",
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                    ...
                                    children: [
                                        ...
                                        filterOptions.programmes.map((programme)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                value: programme,
                                                children: programme
                                            }, programme, false, {
                                                fileName: "[project]/src/app/components/Reports/Filters.jsx",
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                    ...
                                    children: [
                                        ...
                                        Array.isArray(fundingWindows) && fundingWindows.length > 0 ? fundingWindows.map((window)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                    ...
                                    children: [
                                        ...
                                        filterOptions.years.map((year)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                value: year,
                                                children: year
                                            }, year, false, {
                                                fileName: "[project]/src/app/components/Reports/Filters.jsx",
...
_s(AdvancedFilters, "tAfBNo2rhLrMKw5ESRVxUlwyCtA=");
_c = AdvancedFilters;
var _c;
...
"[project]/src/app/components/Reports/Exports.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ExportManager({ companies = [], placements = [], allocatedLearners = [], agreements = [], fundingWindows = [], filters = {}, onExport }) {
    _s();
    const [exportType, setExportType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('registration');
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: exportOptions.map((option)=>{
                    ...
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        style: {
                            backgroundColor: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["COLORS"].bgWhite,
                            borderColor: isSelected ? option.color : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["COLORS"].border
                        },
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            Object.values(filters).some((v)=>v !== '') && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ExportManager, "gjLHOJL/biosXs+7j5pXN29AFQQ=");
_c = ExportManager;
var _c;
__turbopack_context__.k.register(_c, "ExportManager");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/app/components/Reports/Search.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LearnerSearch({ placements = [], allocatedLearners = [], companies = [], agreements = [], students = [], filters = {}, onQuickAction }) {
    ...
    const normalizedPlacements = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "LearnerSearch.useMemo[normalizedPlacements]": ()=>placements.map({
                "LearnerSearch.useMemo[normalizedPlacements]": (p)=>({
                        ...p,
            ...
            }["LearnerSearch.useMemo[normalizedPlacements]"])
    }["LearnerSearch.useMemo[normalizedPlacements]"], [
        placements
    ]);
    const normalizedCompanies = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "LearnerSearch.useMemo[normalizedCompanies]": ()=>companies.map({
                "LearnerSearch.useMemo[normalizedCompanies]": (c)=>({
                        ...c,
                        id: c.company_id,
                        companyName: c.company_name,
                        industrySector: c.industry
                    })
            }["LearnerSearch.useMemo[normalizedCompanies]"])
    }["LearnerSearch.useMemo[normalizedCompanies]"], [
        companies
    ]);
    const normalizedAgreements = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "LearnerSearch.useMemo[normalizedAgreements]": ()=>agreements.map({
                "LearnerSearch.useMemo[normalizedAgreements]": (a)=>({
                        ...a,
                        id: a.agreement_id,
                        setaName: a.name
                    })
            }["LearnerSearch.useMemo[normalizedAgreements]"])
    }["LearnerSearch.useMemo[normalizedAgreements]"], [
        agreements
    ]);
    const normalizedAllocations = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "LearnerSearch.useMemo[normalizedAllocations]": ()=>allocatedLearners.map({
                "LearnerSearch.useMemo[normalizedAllocations]": (a)=>({
                        ...a,
                        studentId: a.student_id,
                        agreementId: a.agreement_id,
                        programmeId: a.programme_id
                    })
            }["LearnerSearch.useMemo[normalizedAllocations]"])
    }["LearnerSearch.useMemo[normalizedAllocations]"], [
        allocatedLearners
    ]);
    const filteredLearners = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "LearnerSearch.useMemo[filteredLearners]": ()=>{
            let results = students;
            // --- Search filter ---
            if (searchTerm) {
                const search = searchTerm.toLowerCase();
                results = results.filter({
                    "LearnerSearch.useMemo[filteredLearners]": (learner)=>{
            ...
            if (filters.faculty) {
                results = results.filter({
                    "LearnerSearch.useMemo[filteredLearners]": (l)=>l.faculty === filters.faculty
                }["LearnerSearch.useMemo[filteredLearners]"]);
            }
            if (filters.seta) {
                results = results.filter({
                    "LearnerSearch.useMemo[filteredLearners]": (l)=>l.agreementId === filters.seta
                }["LearnerSearch.useMemo[filteredLearners]"]);
            }
            if (filters.programme) {
                results = results.filter({
                    "LearnerSearch.useMemo[filteredLearners]": (l)=>l.programme === filters.programme
                }["LearnerSearch.useMemo[filteredLearners]"]);
            }
            if (filters.fundingWindow) {
                results = results.filter({
                    "LearnerSearch.useMemo[filteredLearners]": (l)=>l.fundingWindowId === filters.fundingWindow
                }["LearnerSearch.useMemo[filteredLearners]"]);
            }
            if (filters.status) {
                const placedLearnerIds = normalizedPlacements.map({
                    "LearnerSearch.useMemo[filteredLearners].placedLearnerIds": (p)=>p.studentId
                }["LearnerSearch.useMemo[filteredLearners].placedLearnerIds"]);
                if (filters.status === 'Unplaced') {
                    results = results.filter({
                        "LearnerSearch.useMemo[filteredLearners]": (l)=>!placedLearnerIds.includes(l.id)
                    }["LearnerSearch.useMemo[filteredLearners]"]);
                } else {
                    results = results.filter({
                        "LearnerSearch.useMemo[filteredLearners]": (l)=>{
                            const placement = normalizedPlacements.find({
                                "LearnerSearch.useMemo[filteredLearners].placement": (p)=>p.studentId === l.id
                            }["LearnerSearch.useMemo[filteredLearners].placement"]);
            ...
            if (filters.hostCompany) {
                const companyPlacements = normalizedPlacements.filter({
                    "LearnerSearch.useMemo[filteredLearners].companyPlacements": (p)=>p.companyId === filters.hostCompany
                }["LearnerSearch.useMemo[filteredLearners].companyPlacements"]);
                const learnerIds = companyPlacements.map({
                    "LearnerSearch.useMemo[filteredLearners].learnerIds": (p)=>p.learnerId
                }["LearnerSearch.useMemo[filteredLearners].learnerIds"]);
                results = results.filter({
                    "LearnerSearch.useMemo[filteredLearners]": (l)=>learnerIds.includes(l.id)
                }["LearnerSearch.useMemo[filteredLearners]"]);
            }
            if (filters.year) {
                results = results.filter({
                    "LearnerSearch.useMemo[filteredLearners]": (l)=>{
                        const placement = placements.find({
                            "LearnerSearch.useMemo[filteredLearners].placement": (p)=>p.learnerId === l.id
                        }["LearnerSearch.useMemo[filteredLearners].placement"]);
                        if (!placement) return false;
                        const year = new Date(placement.startDate).getFullYear();
                        return year.toString() === filters.year;
            ...
            // --- Map student details ---
            const resultsWithStudentData = results.map({
                "LearnerSearch.useMemo[filteredLearners].resultsWithStudentData": (learner)=>{
                    const studentData = students.find({
                        "LearnerSearch.useMemo[filteredLearners].resultsWithStudentData.studentData": (s)=>s.id === learner.studentId || s.studentId === learner.studentId
                    }["LearnerSearch.useMemo[filteredLearners].resultsWithStudentData.studentData"]);
                    return {
                        ...learner,
                        studentData
                    };
                }
            }["LearnerSearch.useMemo[filteredLearners].resultsWithStudentData"]);
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                        ...
                                        children: enrichedLearners.map((learner)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: "px-6 py-4",
                                                        children: learner.company ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "flex items-center gap-2",
                                                            children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: "px-6 py-4",
                                                        children: learner.placement ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "text-sm",
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                            children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(learner.placement.startDate)
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/src/app/components/Reports/Search.jsx",
                                                                            lineNumber: 306,
                                                                            columnNumber: 31
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                            children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(learner.placement.endDate)
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/src/app/components/Reports/Search.jsx",
                                                                            lineNumber: 310,
                                                                            columnNumber: 31
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                style: {
                                                    backgroundColor: currentPage === pageNum ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["COLORS"].primary : 'transparent',
                                                    color: currentPage === pageNum ? 'white' : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["COLORS"].text
                                                },
                                                children: pageNum
                                            }, i, false, {
                                                fileName: "[project]/src/app/components/Reports/Search.jsx",
...
_s(LearnerSearch, "79s5qrf+ctMyjtKSnk/0il9V8DE=");
_c = LearnerSearch;
var _c;
__turbopack_context__.k.register(_c, "LearnerSearch");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/src/app/components/Reports/ReportsPage.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$trending$2d$up$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__TrendingUp$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/trending-up.js [app-client] (ecmascript) <export default as TrendingUp>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$utils$2f$helpers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/utils/helpers.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$Reports$2f$ReportsDashboard$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/Reports/ReportsDashboard.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$Reports$2f$Filters$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/Reports/Filters.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$Reports$2f$Exports$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/Reports/Exports.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$Reports$2f$Search$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/Reports/Search.jsx [app-client] (ecmascript)");
...
const ReportsPage = ()=>{
    ...
    const [selectedStudent, setSelectedStudent] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null); // ADD THIS
    const [showProfileModal, setShowProfileModal] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // ADD THIS
    const [filters, setFilters] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        faculty: '',
        seta: '',
        programme: '',
    ...
    const fetchFundingWindows = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`https://seta-api-3g5xl.ondigitalocean.app/api/administrators/getFundingWindows/`, {
                withCredentials: true
            });
    ...
    const fetchAllStudents = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('https://seta-api-3g5xl.ondigitalocean.app/api/administrators/students', {
                withCredentials: true
            });
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "space-y-6",
                    children: [
                        activeTab === 'dashboard' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$Reports$2f$ReportsDashboard$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                            companies: companies,
                        ...
                        activeTab === 'analytics' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$Reports$2f$Charts$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                            companies: companies,
                            placements: placements,
                            allocatedLearners: allocatedLearners,
                            agreements: agreements,
                        ...
                        activeTab === 'search' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$Reports$2f$Filters$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    companies: companies,
                                    agreements: agreements,
                                    fundingWindows: fundingWindows,
                                    allocatedLearners: allocatedLearners,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$Reports$2f$Search$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    placements: placements,
                                    allocatedLearners: allocatedLearners,
                                    companies: companies,
                                    agreements: agreements,
                        ...
                        activeTab === 'export' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$Reports$2f$Exports$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                            companies: companies,
                            placements: placements,
                            allocatedLearners: allocatedLearners,
                            agreements: agreements,
...
_s(ReportsPage, "LEzgq/S8XFhcnk0c/MJG2SEJjy4=");
_c = ReportsPage;
...
//# sourceMappingURL=src_app_components_074d7faa._.js.map