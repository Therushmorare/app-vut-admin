        ...
        <div className="fixed inset-0 flex items-center justify-center z-60 px-4">
          <div className={`max-w-md w-full p-6 rounded-lg shadow-2xl transform transition-all duration-300 ${
            ...
            <div className="flex items-center space-x-3">
              {notification.type === 'success' ? (
                <div className="w-8 h-8 rounded-full bg-[#201c52] flex items-center justify-center">
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div className="flex items-center space-x-3 mb-6">
                  <div className="p-2 bg-blue-100 rounded-lg">
                    <Key className="w-5 h-5 text-[#201c52]" />
                  </div>
                  <div>
                    ...
                    <div>
                      ...
                      {passwordData.confirmPassword && !passwordMatch.showError && passwordData.confirmPassword.length > 0 && (
                        <div className="mt-2 p-2 bg-green-50 rounded-lg border border-green-200">
                          <p className="text-sm text-[#201c52] flex items-center space-x-2">
                            <span className="w-3.5 h-3.5 rounded-full bg-[#201c52] text-white flex items-center justify-center text-xs">✓</span>
